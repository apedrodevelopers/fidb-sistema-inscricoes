...
<head>
  ...
  <title>Novo Curso — Capacita CFTI</title>
...
<body>
  ...
  <div class="area-principal">
    <header class="barra-topo">
      <div>
        <div class="barra-topo-titulo">Novo Curso</div>
        <div class="barra-topo-sub">Preencha os dados do novo curso</div>
      </div>
    </header>
    ...
    <main class="conteudo">
      ...
      <div class="cab-secao">
        <div>
          <div class="cab-titulo">Adicionar curso</div>
          <div class="cab-sub">Todos os campos com * são obrigatórios</div>
        </div>
        <a href="listar.php" class="btn btn-secundario">← Voltar à lista</a>
      </div>

      <!-- action="criar.php" method="POST" — a implementar no backend -->
      <form action="../../backend/curso.php?action=INSERT" method="POST">
        ...
        <div class="cartao animar">
          ...
          <div class="cartao-corpo">
            ...
            <div class="linha-2">
              <div class="grupo">
                ...
                <select id="emoji" name="emoji">
                  ...
                  ?>
                    <option value="<?= $index ?>"><?= $emoji . " " . ucfirst($index) ?> </option>
                  <?php
                  }
                  ?>
                </select>
            ...
            <div class="grupo">
              ...
              <input type="text" id="nome" name="nome" placeholder="Ex: Desenvolvimento Web Frontend" required>
            </div>

            <div class="grupo">
              <label class="rotulo" for="subtitulo">Subtítulo / Tecnologias <span class="obg">*</span></label>
              <input type="text" id="subtitulo" name="subtitulo" placeholder="Ex: HTML, CSS, JavaScript & Frameworks" required>
            </div>
            ...
            <div class="linha-2">
              ...
              <div class="grupo">
                ...
                <select id="duracao" name="duracao">
                  ...
                  <option selected>4 meses</option>
          ...
          <div class="cartao-corpo">
            ...
            <div class="linha-3">
              ...
              <div class="grupo">
                ...
                <input type="number" id="vagas" name="vagas" min="1" placeholder="Ex: 20" required>
              </div>
              <div class="grupo">
                <label class="rotulo" for="preco">Propina (AOA)</label>
                <input type="number" id="preco" name="preco" min="0" step="500" placeholder="Ex: 45000">
              </div>
            </div>
            ...
            <div class="linha-2">
              ...
              <div class="grupo">
                ...
                <select id="horario" name="horario">
                  ...
                  <option>Pós-laboral (18h–21h)</option>
                  <option>Sábados (08h–13h)</option>
